...
Un premier stratégie pour détecter les données aberrantes est l'utilisation d'une méthode graphique. Dans ce cas, le boxplot a été utilisé.
...
```{r echo = FALSE}
sliderInput("var_adjust", label = "Variables à montrer:",
              min = 3, max = 11, value = 5, step = 1)
```
...
```{r}
kable(dragons_imp[which(is_out == 0), ], align = 'c',
